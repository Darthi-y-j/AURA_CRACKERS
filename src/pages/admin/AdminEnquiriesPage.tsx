    ...
    <>
      ...
      <div className="flex flex-1 flex-col overflow-hidden p-4 sm:p-6">
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 lg:flex-row">
          ...
          {/* Detail panel */}
          <section className="admin-card flex min-h-0 flex-1 flex-col overflow-hidden">
            {!selectedEnquiry ? (
              ...
              <>
                <div className="border-b border-navy-900/8 px-5 py-4 sm:px-6">
                ...
                <div className="border-t border-navy-900/8 bg-cream-50/50 px-5 py-4 sm:px-6">
